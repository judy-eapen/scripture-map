...
import type { SceneEnergy, StoryMapData } from '@/lib/story-map-data'
...
import type { Scene } from '@/lib/story-map-data'
...
export default function StoryMap({ data }: { data: StoryMapData }) {
  return (
