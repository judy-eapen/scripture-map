...
const bank: ChapterBank = {
  ...
  rows: [
    ...
    tf(3, 'Mark says the Pharisees asked Jesus about divorce because they sincerely wanted to learn from Him.', false, 2, 'Mark says they asked the question "testing Him."'),
    ...
    blank(3, 'And Jesus answered and said to them, "Because of the _____ of your heart he wrote you this precept.', 'hardness', 5),
    word(3, 'Jesus told the Pharisees that Moses wrote the divorce precept because of the ___ of their heart.', 'hardness', 5, ['hard']),
    ...
    tf(3, 'Jesus told the Pharisees, "What Moses has joined together, let not man separate."', false, 9, 'Jesus said "what God has joined together, let not man separate."'),
    ...
    tf(3, 'The disciples asked Jesus again about divorce while they were still standing in front of the Pharisees.', false, 10, 'They asked Him again "in the house."'),
    word(2, 'Where were the disciples when they asked Jesus again about the matter of divorce?', 'house', 10, ['in the house', 'the house']),

    blank(3, 'So He said to them, "Whoever divorces his wife and marries another commits _____ against her.', 'adultery', 11),
    ...
    word(3, 'Jesus told His disciples that whoever divorces his wife and marries another commits what against her?', 'adultery', 11),
    ...
    blank(3, 'Then they brought little children to Him, that He might touch them; but the _____ rebuked those who brought them.', 'disciples', 13),
    ...
    sa(3, 'After telling the rich man to sell what he had and give to the poor, what did Jesus tell him to do next?', 'Come, take up the cross, and follow Me.', 21),
    ...
    blank(3, 'But he was sad at this word, and went away sorrowful, for he had great _____.', 'possessions', 22),
    word(1, 'The man who went away sorrowful from Jesus did so because he had great ___.', 'possessions', 22, ['wealth', 'riches']),
    sa(3, 'Why did the man who asked about eternal life go away sorrowful?', 'Because he had great possessions and Jesus had told him to sell whatever he had.', 22),
    ...
    tf(3, 'After the camel saying, the disciples asked Jesus to His face, "Who then can be saved?"', false, 26, 'They said it "among themselves."'),
    ...
    sa(3, 'When the disciples asked "Who then can be saved?", what contrast did Jesus draw between men and God?', 'With men it is impossible, but not with God; for with God all things are possible.', 27),
    ...
    blank(3, 'who shall not receive a _____ now in this time—houses and brothers and sisters and mothers and children and lands, with persecutions—and in the age to come, eternal life.', 'hundredfold', 30, ['hundred fold', '100 fold', '100fold']),
    word(3, 'Along with houses, family, and lands, what did Jesus say His followers would receive "now in this time"?', 'persecutions', 30, ['persecution', 'with persecutions']),
    ...
    tf(3, 'On the road up to Jerusalem, Jesus walked behind His disciples.', false, 32, '"Jesus was going before them."'),
    sa(3, 'Whom did Jesus take aside on the way to Jerusalem, and what did He begin to tell them?', 'He took the twelve aside and began to tell them the things that would happen to Him.', 32),
    ...
    sa(3, 'What did James and John say when they first came to Jesus with their request?', 'Teacher, we want You to do for us whatever we ask.', 35),
    ...
    sa(3, 'What two things did Jesus ask James and John whether they were able to share with Him?', 'To drink the cup that He drinks and to be baptized with the baptism He is baptized with.', 38),
    ...
    tf(3, 'Jesus told James and John that the seats on His right and left were His to give to whomever He chose.', false, 40, 'He said they were "not Mine to give, but it is for those for whom it is prepared."'),
    ...
    blank(3, 'Now they came to Jericho. As He went out of Jericho with His disciples and a great multitude, blind Bartimaeus, the son of Timaeus, sat by the road _____.', 'begging', 46),
    tf(3, 'Jesus met blind Bartimaeus as He was entering Jericho.', false, 46, 'Bartimaeus sat by the road "as He went out of Jericho."'),
    ...
    tf(3, 'When many warned Bartimaeus to be quiet, he stopped crying out.', false, 48, 'He "cried out all the more."'),
    sa(3, 'When many people warned Bartimaeus to be quiet, how did he respond?', 'He cried out all the more, "Son of David, have mercy on me!"', 48),
    ...
    sa(3, 'What happened immediately after Jesus told Bartimaeus his faith had made him well?', 'He immediately received his sight and followed Jesus on the road.', 52),
