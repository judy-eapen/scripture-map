...
const bank: ChapterBank = {
  book: '2 Kings', chapter: 1, tag: 'quiz-v2-2kings-1', rows: [
    ...
    blank(2, 'He said to them, "What _____ of man was he who came to meet you and told you these things?"', 'kind', 7),
    ...
    tf(2, 'Ahaziah asked his messengers what kind of man had come to meet them.', true, 7),
    ...
    tf(2, 'When the messengers told Ahaziah what the man wore, he said, "It is Elijah the Tishbite."', true, 8),
    mc(3, 'What did the messengers say the man who met them was wearing?', ['A garment of haircloth with a leather girdle', 'An iron breastplate with a red cloak', 'A linen robe with a gold belt', 'Sackcloth with ropes on his head'], 8),
    ...
    blank(2, 'do not be _____ of him." So he arose and went down with him to the king,', 'afraid', 15),
