...
sa(1,'What did Jesus preach to the crowded house?','the word',2,['word']),tf(3,'There was still plenty of room near the door.',false,2,'There was no room even near the door.'),
...
sa(2,'What part of the house did the men uncover?','the roof',4,['roof']),tf(1,'The men lowered the paralytic on his bed through the roof.',true,4),
...
sa(1,'Who reasoned silently in their hearts?','the scribes',6,['scribes']),tf(2,'The scribes spoke their reasoning aloud at first.',false,6,'They were reasoning in their hearts.'),
...
sa(2,'How did Jesus know what the scribes were thinking?','He perceived it in His spirit',8,['perceived in His spirit']),tf(3,'Jesus asked why they reasoned these things in their hearts.',true,8),
...
sa(2,'What did the healed man carry out?','the bed',12,['his bed','bed']),tf(1,'The crowd glorified God and said they had never seen anything like it.',true,12),
...
sa(2,'Who questioned Jesus’ disciples about His dinner companions?','the scribes and Pharisees',16,['scribes and Pharisees']),tf(3,'Jesus ate only with religious leaders at Levi’s house.',false,16,'He ate with tax collectors and sinners.'),
...
sa(2,'When would the bridegroom’s friends fast?','when the bridegroom was taken away',20,['when the bridegroom is taken away']),tf(3,'Jesus said the friends would never fast.',false,20,'They would fast when the bridegroom was taken away.'),
...
sa(1,'What must hold new wine?','new wineskins',22),tf(3,'Putting new wine into old wineskins preserves both perfectly.',false,22,'The wine spills and the wineskins are ruined.'),
...
sa(2,'Who challenged the disciples’ Sabbath action?','the Pharisees',24,['Pharisees']),tf(1,'The Pharisees called the disciples’ action unlawful on the Sabbath.',true,24),
