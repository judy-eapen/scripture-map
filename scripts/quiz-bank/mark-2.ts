...
const bank: ChapterBank = {
  ...
  rows: [
    ...
    mc(3, 'What two sayings did Jesus ask the scribes to compare when He asked, "Which is easier"?', ['"Your sins are forgiven" and "Arise, take up your bed and walk"', '"Follow Me as My disciple" and "Return now to your own house"','"Be cleansed from your disease" and "Stretch out your hand"','"Your faith has saved you" and "Depart from this place in peace"'], 9),
    ...
    mc(1, 'How did the crowd at Capernaum react when the paralytic got up, took his bed, and walked out?', ['They were amazed, glorified God, and said they had never seen this','They became afraid and begged Jesus to leave their entire region','They hurried away to bring sick people from the surrounding towns','They took offense and dismissed Jesus as merely the carpenter’s son'], 12),
    ...
    mc(1, 'What did Jesus say happens when new wine is put into old wineskins?', ['The wine bursts the skins, spills out, and ruins the wineskins','The wine turns sour while the old wineskins become hard','The old skins stretch enough to contain the new wine safely','The wine ages properly and both wineskins remain preserved'], 22),
