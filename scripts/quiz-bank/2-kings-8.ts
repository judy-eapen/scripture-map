...
const bank: ChapterBank = {
  book: '2 Kings', chapter: 8, tag: 'quiz-v2-2kings-8', rows: [
    ...
    word(3, 'How long would the famine last?', 'seven years', 1, ['seven', '7 years', '7']),
    ...
    word(2, 'Whose word did the woman obey?', 'the man of God’s', 2, ['Elisha’s word', 'the word of the man of God']),
    ...
    word(1, 'From where did she return?', 'the land of the Philistines', 3, ['Philistia', 'Philistine land']),
    ...
    word(2, 'What subject interested the king?', 'Elisha’s great deeds', 4, ['the great things Elisha had done', 'Elisha’s miracles']),
    ...
    word(1, 'What did the woman appeal to recover?', 'her house and land', 5, ['her property', 'house and her land']),
    ...
    word(2, 'From what point was the produce to be calculated?', 'the day she left the land', 6, ['when she left', 'from the day she departed']),
    ...
    word(1, 'What title was used when Elisha’s arrival was reported?', 'the man of God', 7, ['man of God']),
    ...
    word(2, 'What was Hazael to take with him?', 'a present', 8, ['gift']),
    ...
    word(1, 'How did Hazael refer to Ben-hadad before Elisha?', 'your son', 9, ['your son Ben-hadad']),
    ...
    word(2, 'What message was Hazael to give Ben-hadad?', 'You shall certainly recover', 10, ['he would certainly recover']),
    ...
    word(2, 'Whom would Hazael harm?', 'the people of Israel', 12, ['Israel', 'Israelites']),
    ...
    word(1, 'How did Hazael describe the predicted violence?', 'this great thing', 13, ['a great thing']),
    ...
    word(2, 'Whose dynasty’s pattern did Jehoram follow?', 'the house of Ahab', 18, ['Ahab’s house']),
    ...
    word(1, 'For whose sake was Judah preserved?', 'David his servant', 19, ['David’s', 'David']),
    ...
    word(1, 'Who had surrounded Joram?', 'the Edomites', 21, ['Edom']),
    ...
    word(2, 'How long did Edom’s revolt remain in effect?', 'to this day', 22),
    ...
    word(2, 'What phrase describes Joram’s death?', 'slept with his fathers', 24, ['he slept with his fathers']),
    ...
    word(1, 'How did Ahaziah act in the LORD’s sight?', 'he did evil', 27, ['evil', 'what was evil']),
