...
word(1,'When did the women come to the tomb?','very early on the first day of the week',2,['first day of the week','when the sun had risen']),tf(3,'The women arrived before the Sabbath had ended.',false,2,'They came after the Sabbath, when the sun had risen.'),
...
word(2,'What had happened to the very large stone?','it had been rolled away',4,['rolled away']),tf(1,'The women found the stone still sealing the tomb.',false,4,'They saw that it had been rolled away.'),
...
word(1,'What announcement did the young man make about Jesus?','He is risen',6,['risen','He has risen']),tf(2,'The young man said Jesus of Nazareth was still lying there.',false,6,'He said Jesus had risen and was not there.'),
...
word(1,'Who will be saved?','the one who believes and is baptized',16,['he who believes and is baptized']),tf(2,'Jesus said unbelief leads to condemnation.',true,16),
...
word(3,'What would happen when believers laid hands on the sick?','they would recover',18,['the sick would recover']),tf(1,'Jesus said deadly drink would certainly kill believers.',false,18,'He said it would by no means hurt them.'),
...
word(2,'How did the Lord confirm the preached word?','through accompanying signs',20,['accompanying signs']),tf(3,'The disciples remained inside and did not preach.',false,20,'They went out and preached everywhere.'),
]};
export default bank;
