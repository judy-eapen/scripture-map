...
const bank: ChapterBank = {
  book: '1 Kings', chapter: 18, tag: 'quiz-v2-1kings-18', rows: [
    ...
    tf(3, 'Samaria was enjoying abundant food when Elijah returned.', false, 2, 'The famine was severe in Samaria.'),
    ...
    word(1, 'What did Obadiah feed the hidden prophets?', 'bread and water', 4),
    tf(2, 'Obadiah hid the prophets after Jezebel tried to cut them off.', true, 4),
    mc(3, 'How did Obadiah protect the LORD’s prophets?', ['He hid one hundred by fifties in a cave and fed them', 'He sent fifty to Judah', 'He armed them against Jezebel', 'He concealed them in Ahab’s palace'], 4),
    ...
    word(2, 'Which two kinds of animals did Ahab hope to save?', 'horses and mules', 5),
    tf(3, 'Ahab wanted to slaughter the remaining animals.', false, 5, 'He wanted grass so the horses and mules could be kept alive.'),

    mc(1, 'How did Ahab and Obadiah search the land?', ['They divided it and went different ways alone', 'They traveled together', 'They sent only servants', 'They stayed in Samaria'], 6),
    blank(3, 'Ahab went in one _____ by himself', 'direction', 6),
    word(1, 'Who went in the other direction?', 'Obadiah', 6, ["Obadi'ah"]),
    tf(2, 'Ahab and Obadiah searched in the same direction.', false, 6, 'They divided the land and went in separate directions.'),
    ...
    word(2, 'How did Obadiah address Elijah?', 'my lord Elijah', 7, ['Elijah', 'my lord']),
    tf(3, 'Obadiah failed to recognize Elijah.', false, 7, 'He recognized Elijah and fell on his face.'),
    ...
    word(1, 'How did Elijah identify himself?', 'It is I', 8),
    tf(2, 'Elijah told Obadiah to conceal his presence from Ahab.', false, 8, 'He told Obadiah to announce that Elijah was there.'),
    ...
    tf(2, 'Obadiah welcomed the assignment without fear.', false, 9, 'He feared Ahab would kill him.'),

    mc(2, 'How widely had Ahab searched for Elijah?', ['In every nation or kingdom he could reach', 'Only within Samaria', 'Only in Judah', 'Only near Mount Carmel'], 10),
    blank(3, 'there is no nation or _____ whither my lord has not sent to seek you', 'kingdom', 10),
    word(1, 'What did Ahab require when a realm said Elijah was absent?', 'an oath', 10),
    tf(2, 'Ahab accepted a simple report that Elijah was not present.', false, 10, 'He made the nation or kingdom swear they had not found Elijah.'),
    ...
    word(2, 'To whom was Obadiah to speak?', 'his lord', 11, ['Ahab']),
    tf(3, 'Elijah told Obadiah to report that he had left.', false, 11, 'The report was that Elijah was here.'),
    ...
    word(1, 'Since when had Obadiah revered the LORD?', 'from his youth', 12, ['my youth', 'youth']),
    ...
    tf(3, 'Obadiah believed the message would guarantee his safety.', false, 14, 'He feared Ahab would kill him.'),

    mc(1, 'What promise did Elijah make?', ['He would surely show himself to Ahab that day', 'He would leave Samaria', 'He would hide from Ahab', 'He would send Obadiah alone'], 15),
    blank(3, 'I will surely show myself to him _____.', 'today', 15),
    word(1, 'Before whom did Elijah say he stood?', 'the LORD of hosts', 15),
    ...
    tf(3, 'Ahab refused to meet Elijah.', false, 16, 'After Obadiah’s report, Ahab went to meet him.'),
    ...
    tf(2, 'Ahab greeted Elijah as Israel’s deliverer.', false, 17, 'He called Elijah the troubler of Israel.'),
    ...
    word(2, 'What had Ahab forsaken?', 'the commandments of the LORD', 18, ['the LORD’s commandments']),
    tf(3, 'Elijah accepted blame for troubling Israel.', false, 18, 'He said Ahab and his father’s house were responsible.'),
    mc(3, 'Why did Elijah say Ahab’s house troubled Israel?', ['They forsook the LORD’s commandments and followed the Baals', 'They hid the LORD’s prophets', 'They searched for grass', 'They refused to meet Elijah'], 18),
    ...
    word(1, 'Where were all Israel and the prophets to gather?', 'Mount Carmel', 19, ['Carmel']),
    ...
    word(2, 'To whom did Ahab send?', 'all the people of Israel', 20, ['all Israel', 'the people of Israel']),
    ...
    word(1, 'How did the people answer Elijah?', 'not a word', 21, ['they did not answer', 'no answer']),
    ...
    word(2, 'What did the people say about Elijah’s proposal?', 'It is well spoken', 24),
    ...
    word(1, 'Why did Elijah tell Baal’s prophets to go first?', 'they were many', 25, ['because they were many']),
    ...
    word(2, 'Around what did the prophets limp?', 'the altar they had made', 26, ['the altar']),
    ...
    word(1, 'When did Elijah begin mocking them?', 'at noon', 27, ['noon']),
    ...
    word(1, 'Why did they cut themselves?', 'after their custom', 28, ['their custom']),
    ...
    mc(1, 'What did Elijah repair?', ['The LORD’s altar that had been thrown down', 'Baal’s altar', 'Ahab’s palace', 'The city wall'], 30),
    blank(3, 'And he _____ the altar of the LORD that had been thrown down.', 'repaired', 30),
    word(1, 'Whom did Elijah invite to come near?', 'all the people', 30, ['the people']),
    ...
    word(1, 'How much seed could the trench contain?', 'two measures', 32, ['two measures of seed', '2 measures']),
    ...
    word(2, 'Where was the water to be poured?', 'on the burnt offering and wood', 33, ['the offering and the wood']),
    ...
    word(1, 'What did Elijah say after the first pouring?', 'Do it a second time', 34, ['second time']),
    ...
    word(1, 'What did Elijah call himself in the prayer?', 'the LORD’s servant', 36, ['thy servant', 'servant']),
    tf(2, 'Elijah said he had done these things at the LORD’s word.', true, 36),

    mc(1, 'What did Elijah want the people to know?', ['That the LORD is God and had turned their hearts back', 'That Ahab was innocent', 'That Baal was sleeping', 'That the famine would continue'], 37),
    blank(2, 'and that thou hast turned their _____ back.', 'hearts', 37),
    word(2, 'Whom did Elijah ask to answer him?', 'the LORD', 37, ['LORD']),
    tf(3, 'Elijah prayed that the people would know Baal was God.', false, 37, 'He prayed that they would know the LORD is God.'),

    mc(1, 'What did the LORD’s fire consume?', ['Offering, wood, stones, dust, and trench water', 'Only the burnt offering', 'Only the wood and stones', 'The prophets of Baal'], 38),
    ...
    mc(3, 'Which complete list describes what the LORD’s fire consumed?', ['Burnt offering, wood, stones, dust, and trench water', 'Bull and wood only', 'Altar and prophets only', 'Jars, seed, and grass'], 38),
    ...
    word(2, 'What did the people confess?', 'The LORD, he is God', 39, ['the LORD is God']),
    ...
    word(1, 'What did Elijah do to the prophets at Kishon?', 'killed them', 40, ['he killed them']),
    ...
    word(2, 'What did Elijah hear?', 'the rushing of rain', 41, ['rain']),
    ...
    word(1, 'What did Elijah bow upon?', 'the earth', 42),
    ...
    word(2, 'What did the servant report at first?', 'There is nothing', 43, ['nothing']),
    ...
    word(1, 'What was Ahab told to prepare?', 'his chariot', 44, ['chariot']),
    tf(2, 'Elijah warned Ahab that rain might stop him.', true, 44),
    mc(3, 'What did Elijah’s servant see on the seventh trip?', ['A little cloud like a man’s hand rising from the sea', 'A wall of fire over Carmel', 'A raven carrying bread', 'A dry wind from Samaria'], 44),
    ...
    word(2, 'What made the heavens grow black?', 'clouds and wind', 45),
    ...
    word(1, 'To what place did Elijah run?', 'the entrance of Jezreel', 46, ['Jezreel']),
