...
const bank: ChapterBank = {
  book: '1 Kings', chapter: 13, tag: 'quiz-v2-1kings-13', rows: [
    ...
    sa(1, 'What happened after the man of God entreated the LORD?', 'The king’s hand was restored', 6, ['his hand was restored', 'restored']),
    ...
    sa(3, 'Where did the king invite the man of God to go?', 'home with him', 7, ['home']),
    ...
    sa(1, 'What two things did the man of God refuse to consume in that place?', 'bread and water', 8, ['bread or water']),
    ...
    sa(3, 'How had the man of God received the command?', 'by the word of the LORD', 9, ['the word of the LORD']),
    ...
    sa(1, 'Who told the old prophet what had happened that day?', 'his sons', 11),
    ...
    sa(1, 'Who saddled the animal for the old prophet?', 'his sons', 13),
    ...
    sa(1, 'How did the man of God answer when asked whether he was the man from Judah?', 'I am', 14),
    ...
    sa(1, 'Where did the man of God eat bread?', 'in his house', 19, ['the prophet’s house', 'his house']),
    ...
    sa(2, 'What animal stood beside the body along with the lion?', 'the ass', 24, ['ass', 'donkey']),
    ...
    sa(2, 'From among whom did Jeroboam make priests?', 'all the people', 33),
    ...
    sa(1, 'What would happen to Jeroboam’s house?', 'it would be cut off and destroyed', 34, ['cut off and destroyed', 'destroyed']),
