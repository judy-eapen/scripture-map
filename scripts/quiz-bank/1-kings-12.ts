...
const bank: ChapterBank = {
  ...
  rows: [
    ...
    mc(3, 'What question did Rehoboam put to the old men?', ['“How do you advise me to answer this people?”', '“Shall I lighten the heavy yoke my father placed on them?”', '“Who is this Jeroboam who has returned from Egypt?”', '“Shall Judah go up and fight to restore the kingdom?”'], 6),
    tf(3, 'The old men Rehoboam consulted had stood before Solomon his father while he was alive.', true, 6),

    mc(3, 'What did the old men advise Rehoboam?', ['Serve the people and answer them with good words', 'Add to their heavy yoke and increase their forced labor', 'Chastise them with scorpions instead of his father’s whips', 'Send them away for three more days before answering'], 7),
    ...
    word(3, 'Rehoboam ___ the counsel which the old men gave him.', 'forsook', 8, ['forsake', 'forsaken']),
    ...
    mc(3, 'What would Rehoboam do to the yoke his father laid on the people?', ['Add to it', 'Lighten it', 'Remove it', 'Divide it'], 11),
    ...
    word(1, 'In what manner did the king answer the people?', 'harshly', 13, ['harsh']),
    ...
    mc(3, 'Why did the king not listen to the people?', ['The LORD brought about this turn to fulfill his word through Ahijah', 'Jeroboam had bribed the young men to give Rehoboam harsh counsel', 'The old men who had served Solomon died before the king answered', 'The people threatened to stone Rehoboam unless he reduced their labor'], 15),

    // ══════════════════════════════════ v16–20 · The kingdom divides
    mc(1, 'What did the people cry when they saw the king would not listen?', ['“What portion have we in David? … To your tents, O Israel!”', '“Long live King Rehoboam, the son of King Solomon!”', '“Give us Jeroboam the son of Nebat as our king!”', '“The LORD has forsaken Israel and the house of David!”'], 16),
    ...
    mc(2, 'After Israel departed, over whom did Rehoboam reign?', ['The Israelites dwelling in the cities of Judah', 'All twelve tribes assembled throughout the kingdom', 'The tribe of Ephraim dwelling around Shechem', 'The people dwelling in Shechem and the hill country'], 17),
    ...
    mc(2, 'How did Rehoboam escape after Adoram was killed?', ['He hastily mounted his chariot and fled to Jerusalem', 'He hid inside a fortified house in the city of Shechem', 'He fled south into Egypt under Pharaoh’s protection', 'He mounted a royal mule and escaped toward Hebron'], 18),
    ...
    mc(2, 'What lasting result followed Israel’s departure from Rehoboam?', ['Israel remained in rebellion against David’s house', 'Israel returned to David’s house after three days', 'Judah rebelled against Jeroboam’s northern rule', 'The divided kingdom reunited under Rehoboam'], 19),
    ...
    tf(2, 'The tribes of Judah and Benjamin both followed the house of David.', false, 20, 'The text says "none that followed the house of David, but the tribe of Judah only".'),
    ...
    mc(2, 'Which two groups did Rehoboam assemble to fight against the house of Israel?', ['The house of Judah and the tribe of Benjamin', 'The tribes of Judah and Ephraim from the hill country', 'The tribes of Benjamin and Levi living near Jerusalem', 'The tribes of Judah and Dan from the southern cities'], 21),
    ...
    tf(2, 'Shemaiah is called “the prophet.”', false, 22, 'He is called "the man of God".'),
    ...
    mc(3, 'To whom was Shemaiah told to deliver the message?', ['Rehoboam, Judah and Benjamin, and the rest of the people', 'Jeroboam and all Israel gathered with him at Shechem', 'The old men and the young men who had counseled the king', 'The priests appointed by Jeroboam to serve at the high places'], 23),
    word(2, 'Rehoboam is called “the son of ___.”', 'Solomon', 23),
    tf(3, 'Shemaiah’s message addresses Rehoboam as “king of Israel.”', false, 23, 'He is addressed as "king of Judah".'),
    ...
    mc(2, 'What did Jeroboam fear in his heart?', ['The kingdom would return to the house of David', 'Egypt would invade Israel and capture the city of Shechem', 'The Levites would rebel against the priests he appointed', 'Shechem would fall to Rehoboam’s assembled army'], 26),
    ...
    mc(2, 'Why was Jeroboam afraid of the people going up to Jerusalem?', ['Their hearts would return to Rehoboam and they would kill Jeroboam', 'They would bring the covenant ark back to the northern tribes', 'They would stop paying tribute to the kingdom’s new government', 'Shemaiah would speak against Jeroboam before the gathered worshipers'], 27),
    ...
    mc(3, 'What did Jeroboam say the calves were?', ['Israel’s gods who had brought them up from Egypt', 'A memorial of Solomon and the kingdom he had built', 'The LORD’s cherubim that had covered the covenant ark', 'The gods of Egypt that had protected Jeroboam in exile'], 28),
    ...
    tf(2, 'The worship connected with the two calves became a sin.', true, 30),
    mc(2, 'What did the worship connected with the two calves become?', ['A sin', 'A feast', 'A memorial', 'A blessing'], 30),
    ...
    tf(3, 'Jeroboam sacrificed to the calves in Dan during the appointed feast.', false, 32, 'The text says "so he did in Bethel, sacrificing to the calves that he had made".'),
    ...
    mc(3, 'How did Jeroboam choose the month for his feast?', ['He devised it from his own heart', 'The LORD commanded it through a prophet', 'He matched the month of the Passover', 'The priests of the high places selected it'], 33),
    ...
    // ══════════════════════════════════ Whole-chapter
    mc(2, 'Who told Rehoboam, “Your father made our yoke heavy”?', ['The assembly of Israel speaking through Jeroboam', 'The old men who had served Solomon his father', 'The young men who had grown up alongside him', 'Jeroboam when he had served under King Solomon'], 4),
    ...
    mc(1, 'Whom did the northern tribes make king over all Israel?', ['Jeroboam the son of Nebat', 'Rehoboam the son of Solomon', 'Adoram over the forced labor', 'Shemaiah the man of God'], 20),
