...
const bank: ChapterBank = {
  book: '2 Kings', chapter: 9, tag: 'quiz-v2-2kings-9', rows: [
    ...
    word(2, 'From whom was Jehu to be separated?', 'his fellows', 2, ['the other commanders']),
    ...
    word(2, 'What describes the messenger’s age?', 'young man', 4, ['young']),
    ...
    word(1, 'How did the messenger identify the intended recipient?', 'To you, O commander', 5, ['to Jehu', 'you']),
    ...
    word(2, 'Where did Jehu go for the anointing?', 'into the house', 6, ['the house', 'inside']),
    ...
    word(1, 'Whose shed blood would be avenged?', 'the LORD’s servants and prophets', 7, ['the prophets and servants of the LORD']),
    ...
    word(2, 'Which social conditions were included?', 'bond or free', 8, ['slave and free']),
    ...
    word(2, 'Where would dogs eat Jezebel?', 'the territory of Jezreel', 10, ['Jezreel']),
    ...
    word(1, 'What did Jehu initially say about the visitor’s talk?', 'You know the fellow and his talk', 11, ['they knew him and his talk']),
    ...
    word(2, 'How did the commanders respond to Jehu’s first dismissal?', 'That is not true; tell us now', 12, ['they demanded the truth', 'tell us now']),
    ...
    word(1, 'Where were the garments placed?', 'under Jehu on the bare steps', 13, ['under him', 'on the bare steps']),
    ...
    word(1, 'Who had wounded Joram?', 'the Syrians', 15, ['Syria']),
    ...
    word(1, 'What question was the rider to ask?', 'Is it peace?', 17, ['is it peace']),
    ...
    word(2, 'What did the watchman observe about the messenger?', 'he reached them but did not return', 18, ['not coming back', 'he stayed with them']),
    ...
    word(1, 'How did the two kings travel?', 'each in his own chariot', 21, ['in their chariots', 'each in his chariot']),
    ...
    word(2, 'Where did Joram’s body fall?', 'in his chariot', 24, ['his chariot']),
    ...
    word(2, 'Whose blood had the LORD seen?', 'Naboth’s and his sons’', 26, ['Naboth and his sons', 'the blood of Naboth and his sons']),
    ...
    word(1, 'Where was Ahaziah shot?', 'at the ascent of Gur by Ibleam', 27, ['ascent of Gur', 'Gur by Ibleam']),
    ...
    word(2, 'Who transported Ahaziah’s body?', 'his servants', 28),
    ...
    word(2, 'From where did Jezebel look?', 'the window', 30, ['a window']),
    ...
    word(1, 'Where was Jehu when Jezebel addressed him?', 'entering the gate', 31, ['at the gate']),
    ...
    word(2, 'In what direction did Jehu look?', 'up to the window', 32, ['toward the window']),
    ...
    word(1, 'What happened after Jezebel struck the ground?', 'horses trampled her', 33, ['they trampled on her', 'she was trampled']),
    ...
    word(2, 'What did Jehu do before giving the burial order?', 'ate and drank', 34, ['he ate and drank']),
    ...
    word(2, 'Where did the prophecy say Jezebel would be eaten?', 'the territory of Jezreel', 36, ['Jezreel']),
    ...
    word(1, 'On what surface would her remains lie?', 'the face of the field', 37, ['the field']),
