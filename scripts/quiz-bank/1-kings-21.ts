...
const bank: ChapterBank = {
  book: '1 Kings', chapter: 21, tag: 'quiz-v2-1kings-21', rows: [
    ...
    word(2, 'What alternative to another vineyard did Ahab offer?', 'its value in money', 2, ['money']),
    ...
    word(1, 'What did Naboth call the vineyard?', 'the inheritance of my fathers', 3, ['his fathers’ inheritance', 'inheritance']),
    ...
    word(1, 'What answer did Ahab report from Naboth?', 'I will not give you my vineyard', 6, ['he would not give the vineyard']),
    ...
    word(2, 'What challenge did Jezebel make about Ahab’s authority?', 'Do you now govern Israel?', 7, ['govern Israel']),
    ...
    word(1, 'To whom were the letters sent?', 'the elders and nobles', 8),
    ...
    word(2, 'Among whom was Naboth to be placed?', 'the people', 9),
    ...
    word(2, 'Where did the officials live?', 'in Naboth’s city', 11, ['his city']),
    ...
    word(1, 'Where was Naboth taken to be stoned?', 'outside the city', 13),
    ...
    word(2, 'Why did Ahab go to the vineyard?', 'to take possession', 16, ['take possession']),
    ...
    word(2, 'What did Elijah answer when Ahab asked if he found him?', 'I have found you', 20),
    ...
    word(1, 'Which males would be cut off?', 'bond or free', 21, ['every male', 'bond and free']),
    ...
    word(1, 'Where would birds eat Ahab’s people?', 'the open country', 24),
    ...
    word(1, 'How uniquely evil was Ahab described?', 'none was like him', 25, ['there was none like Ahab']),
    ...
    word(1, 'When would the evil come?', 'in his son’s days', 29, ['his son’s days']),
