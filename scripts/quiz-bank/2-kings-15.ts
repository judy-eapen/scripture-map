...
const bank: ChapterBank = {
  book: '2 Kings', chapter: 15, tag: 'quiz-v2-2kings-15', rows: [
    ...
    tf(2, 'Azariah became king over the northern kingdom of Israel.', false, 1, 'Azariah son of Amaziah began to reign over Judah.'),
    ...
    tf(3, 'Azariah rejected the example set by his father Amaziah.', false, 3, 'He did what was right according to all that his father Amaziah had done.'),
    ...
    tf(2, 'Azariah continued governing the people personally despite living separately.', false, 5, 'Jotham took charge of the household and governed the people.'),
    mc(3, 'How did leprosy change Azariah’s rule?', ['He lived apart while Jotham governed', 'He surrendered Judah’s throne to Assyria', 'He transferred his household to Samaria', 'The priests governed without help from Jotham'], 5),
    ...
    tf(3, 'Azariah was buried in Samaria among Israel’s kings.', false, 7, 'He was buried with his fathers in the city of David.'),
    ...
    tf(3, 'Zechariah departed from Jeroboam’s sins and did what was right.', false, 9, 'He did evil and did not depart from Jeroboam’s sins.'),
    ...
    tf(3, 'The chapter claims to contain every deed of Zechariah.', false, 11, 'It directs readers to the Book of the Chronicles of the Kings of Israel for the rest.'),

    mc(1, 'What promise was fulfilled through Zechariah’s reign?', ['Jehu’s line would rule through four generations', 'The royal house of David would permanently end', 'The kingdom of Israel would never face invasion', 'Four successive prophets would govern Israel'], 12),
    ...
    mc(3, 'Why is Zechariah’s brief reign important in the covenant history?', ['It completed the promise of four generations to Jehu', 'It marked the beginning of King David’s dynasty', 'It fulfilled Jonah’s prophecy about Israel’s border', 'It permanently ended the political power of Assyria'], 12),
    ...
    tf(3, 'Shallum began his reign during Uzziah’s twenty-seventh year.', false, 13, 'Shallum began to reign in Uzziah’s thirty-ninth year.'),
    ...
    tf(3, 'Shallum’s conspiracy was omitted from Israel’s royal annals.', false, 15, 'His deeds and the conspiracy he made were written in Israel’s chronicles.'),
    ...
    tf(3, 'Menahem began reigning during Azariah’s fifty-second year.', false, 17, 'Menahem began in Azariah’s thirty-ninth year.'),
    ...
    tf(3, 'Menahem paid Pul in order to remove himself from royal power.', false, 19, 'He paid Pul so that Assyria would help confirm Menahem’s hold on the kingdom.'),
    ...
    tf(3, 'No written record preserved Menahem’s other acts.', false, 21, 'They were written in the Book of the Chronicles of the Kings of Israel.'),
    ...
    tf(3, 'Pekah attacked Pekahiah outside Samaria’s royal citadel.', false, 25, 'He killed Pekahiah in Samaria, in the citadel of the king’s house.'),
    ...
    tf(3, 'Pekah’s reign began in Azariah’s thirty-ninth year.', false, 27, 'Pekah began reigning in Azariah’s fifty-second year.'),
    ...
    tf(3, 'Tiglath-pileser’s invasion left Galilee and Naphtali untouched.', false, 29, 'He captured the named northern cities, Gilead, Galilee, and all Naphtali.'),
    ...
    mc(1, 'Whom did the LORD begin sending against Judah?', ['Rezin of Syria and Pekah of Israel', 'Pul and Tiglath-pileser of Assyria', 'Hoshea and Menahem of Israel', 'The neighboring nations of Edom and Moab'], 37),
